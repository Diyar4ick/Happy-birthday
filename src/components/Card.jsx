  ...
  return (
    ...
    <div className="w-[400px]  h-screen flex flex-col items-center justify-center">
      ...
      <div id="card" className={`${cardClass}`} onClick={toggleCard}>     
        <div id="card-inside">
          <div className="wrap">
            <p>Туылған күнің құтты болсын ардақты әке</p>
            <p>43 жасқа толған туған күніңізде денсаулық пен шыдамдылық тілеймін.</p>
            <p>
              Сіздің жұмысыңызда да бәрі жақсы болады деп сенемін.
            </p>
            <p>
            Алдағы жылдары маған деген үміттеріңізді ақтауға тырысамын.
            </p>
            <p className="signed">Atabek Xaldibaev</p>
          </div>
        </div>
